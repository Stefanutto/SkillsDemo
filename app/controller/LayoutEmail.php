...
class LayoutEmail{
    ...
    public function GetBody($title, $p1 = "", $p2 = ""){
        $html = "
                                        ...
                                        <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                                            <tr>
                                                <td align='center' valign='top' style='padding: 36px 24px;'>
                                                    <a href='http://www.sivoe.com.br/' target='_blank' style='display: inline-block;'>
                                                    <img src='" . LOGO_EMAIL . "' alt='Logo' border='0' style='max-width: 600px;display: block;'>
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                                        ...
                                        <tr>
                                            <td align='left' bgcolor='#ffffff' style='padding: 24px; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf'>
                                                <p style='margin: 0;'>Atenciosamente, Carteira do Holder. </p>  
                                            </td>
                                        </tr>
                                        <!-- end copy -->
                                    ...
                                    <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                                        ...
                                        <tr>
                                            <td align='center' bgcolor='#e9ecef' style='padding: 12px 24px; font-size: 14px; line-height: 20px; color: #666;'>
                                                <p style='margin: 0;font-size: 20px;'>Carteira do Holder | Sistema de Gestão de Carteira.</p>
                                            </td>
                                        </tr>
                                        <!-- end permission -->
                                    </table>
    ...
    public function GetHTML($title, $p1 = "", $p2 = ""){
        $html = "<!DOCTYPE html>
                <html>
                " . $this->GetHeader() . "
                " . $this->GetBody( $title, $p1, $p2) . "
                </html>";
        return $html;
    }
}
